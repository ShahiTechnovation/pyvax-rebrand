...
export default function DocsLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen grow flex flex-col md:flex-row bg-[#0A0A0A] text-[#F2F2F2] selection:bg-[#E84142] selection:text-white font-[family-name:var(--font-ibm-plex)] relative pt-16">
