...
const STEPS = [
  {
    ...
    desc: 'Create your Synthesis hackathon profile on the official platform.',
    time: '2 MIN',
    action: 'REGISTER',
  ...
  },
  {
    ...
    desc: 'Sign up on PyVax to get your classified access code via email.',
    time: '1 MIN',
    action: 'JOIN',
  ...
  },
  {
    num: 3,
    title: 'Get Your Code',
    desc: 'Check your email for the 8-char code → classified.pyvax.xyz/[code]',
    time: '1 MIN',
    action: 'CHECK EMAIL',
    link: null,
    icon: '🔐',
  },
  {
    ...
    desc: 'pip install classified-agent — the PyVax CLI for Synthesis.',
    time: '1 MIN',
    action: 'INSTALL',
    link: null,
    icon: '⚡',
  ...
  },
  {
    ...
    desc: 'classified-agent run — builds, tests, and submits your entry.',
    time: '5 MIN',
    action: 'RUN',
    link: null,
    icon: '🤖',
  ...
  },
  {
    num: 6,
    title: 'Tweet & Submit',
    desc: 'Share your build on X with #ClassifiedHack and submit for review.',
    time: '1 MIN',
    action: 'TWEET',
    link: 'https://x.com/intent/tweet?text=🔴%20I%20just%20built%20an%20autonomous%20agent%20with%20%40PyVax%20for%20%23Synthesis%20Hackathon%0A%0A%24%2075K%20in%20prizes%20%E2%9A%A1%0A%0AJoin%20the%20classified%20hack%20%F0%9F%91%87&url=https%3A%2F%2Fclassified.pyvax.xyz',
    icon: '🐦',
  },
]
